...
const ContactUs = () => {
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "0a2334dd-c9d2-49b5-80b6-8919ba7e531c");
    ...
    return (
        <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
            <Title title='Reach out of us' desc='We would love to hear from you!' />
            <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
                ...
                <div>
                    ...
                    <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                        ...
                        <input name="email" type="email" placeholder='Enter the Email' className='w-full p-3 text-sm outline-none' required />
                    </div>
                </div>
                <div className='sm:col-span-2'>
                    <p className='mb-2 text-sm font-medium'>Message</p>
                    <textarea name="message" row={8} placeholder='Enter your message' className='w-full p-3 text-sm outline-none rounded-lg border border-gray-300 dark:border-gray-600' required />
                </div>
