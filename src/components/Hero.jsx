...
const Hero = () => {
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
      ...
      <motion.p
        ...
        viewport={{ once: true }}
        className='text-sm sm:text-lg font-medium text-gray-500 dark:text-gray-400/75 max-w-4/5 sm:max-w-lg pb-3'
      >
