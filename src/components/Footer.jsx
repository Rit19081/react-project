    ...
    <div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
      <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
        <div className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
          ...
          <p className='max-w-md'>From strategy to execution, we are your partners in growth.</p>
        ...
        <div className='text-gray-600 dark:text-gray-400'>
          ...
          <div className='flex gap-2 text-sm'>
            <input type="email" placeholder='Enter your email' className='border border-gray-300 dark:border-gray-600 w-full p-3 text-sm outline-none rounded' />
            <button className='bg-primary text-white rounded-md px-6'>Subscribe</button>
          </div>
        </div>
      </div>
